...
from watchlist_app.views import movie_list, movie_details,add_movie,stream_list,stream_details,AddStreamingPlatform,view_streaming_platforms,genre_list,ticket_sales,rating_analysis
